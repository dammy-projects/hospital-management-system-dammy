...
<style>
/* Compact styles for smaller category cards */
...
/* Ensure proper spacing between category name and ID */
.card .title.is-6 {
...
<div class="page-transition mt-4">
    ...
    <div class="columns is-vcentered mb-4">
        <div class="column">
            ...
            <p class="subtitle">Manage inventory categories and classifications</p>
        </div>
        <div class="column is-narrow">
            <button class="button is-primary" id="addCategoryBtn">
                <span class="icon">
                ...
                <div class="column is-6">
                    <div class="field">
                        ...
                        <div class="control has-icons-left">
                            <input class="input" type="text" id="searchInput" placeholder="Search by category name..." />
    ...
    <div id="categoriesContainer">
        <div class="columns is-multiline categories-grid" id="categoriesGrid">
    ...
    <div class="has-text-centered mt-6 mb-6" id="emptyState" style="display: none;">
        ...
        <p class="title is-5 has-text-grey mt-3">No categories found</p>
        <p class="subtitle is-6 has-text-grey">Try adjusting your search criteria or add a new category</p>
    </div>
...
<div class="modal" id="categoryModal">
    ...
    <div class="modal-card">
        <header class="modal-card-head">
            <p class="modal-card-title" id="modalTitle">Add New Category</p>
        ...
        <section class="modal-card-body">
            <form id="categoryForm">
                ...
                <div class="field">
                    ...
                    <p class="help">Enter a unique category name (e.g., Medications, Medical Supplies, etc.)</p>
                </div>
            </form>
        </section>
        <footer class="modal-card-foot">
            <button class="button is-success" id="saveCategory">Save Category</button>
...
<div class="modal" id="deleteModal">
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body">
            <div class="content">
                <p>Are you sure you want to delete this inventory category?</p>
                <p><strong id="deleteCategoryName"></strong></p>
                <p class="has-text-danger">This action cannot be undone and may affect related inventory items.</p>
            </div>
        </section>
        <footer class="modal-card-foot">
            <button class="button is-danger" id="confirmDelete">Delete Category</button>
...
<!-- JavaScript -->
<script src="js/inventory_categories.js"></script>
